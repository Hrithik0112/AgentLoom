...
import type { RunResult, State, StepEvent } from '../../packages/engine/index.ts'
...
export const saveDoc = (doc: LoomDoc) => localStorage.setItem(DOC_KEY, JSON.stringify(doc))
...
export const loadVersions = (): LoomDoc[] => JSON.parse(localStorage.getItem(VERSIONS_KEY) ?? '[]')
