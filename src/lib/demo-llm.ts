...
export const demoLLM = () =>
  new FakeLLM(
    [
      ['Classify', 'billing'],
      ['billing reply', 'Sorry about the double charge. I have refunded the duplicate.'],
      ['troubleshooting', 'Try clearing the app cache, then reopen settings.'],
      ['three concrete facts', 'It survives vacuum. It predates trees. It is under a millimetre long.'],
